    ...
    public class JsonClassGenerator : IJsonClassGeneratorConfig
    {
        ...
        public void GenerateClasses()
        {
            ...
            if (writeToDisk)
            {
                ...
                if (writeToDisk && !NoHelperClass && ExplicitDeserialization) File.WriteAllText(Path.Combine(TargetFolder, "JsonClassHelper.cs"), NFinalJsonGenerator.JsonClassGeneratorLib.Resource.JsonClassHelper);
                if (SingleFile)
                {
