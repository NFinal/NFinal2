...
namespace System
{
    ...
    public class UrlAttribute:Attribute
    {
        public UrlAttribute(string urlString, params string[] queryString)
        {
            ...
            this.methodType = NFinal.MethodType.NONE;
            this.contentType = "text/html; charset=utf-8";
            this.compressMode = NFinal.CompressMode.None;
        }
        public string urlString { get; set; }
        public string[] queryString { get; set; }
        public NFinal.MethodType methodType { get; set; }
        public string contentType { get; set; }
        public NFinal.CompressMode compressMode { get; set; }
    }
    /// <summary>
    /// form表单提交并返回html
    /// </summary>
    ...
    public class GetHtmlAttribute : UrlAttribute
    {
        ...
        {
            this.methodType = NFinal.MethodType.GET;
            this.contentType = "text/html; charset=utf-8";
        }
    }
    /// <summary>
    ...
    public class PostHtmlAttribute : UrlAttribute
    {
        ...
        {
            this.methodType= this.methodType = NFinal.MethodType.POST;
            this.contentType = "text/html; charset=utf-8";
        }
    }
    ///// <summary>
    ...
    public class PostJsonAttribute : UrlAttribute
    {
        ...
        {
            this.methodType = NFinal.MethodType.POST;
            this.contentType = "application/json; charset=utf-8";
        }
    }
    ///// <summary>
