...
namespace NFinal.Lib.Oauth
{
    public class kaixin_helper
    {
        ...
        public static IDictionary<string, object>  get_access_token(string code, string state)
        {
            //获得配置信息
        ...
        /// <returns>Dictionary</returns>
        public static IDictionary<string, object> get_info(string access_token, string fields)
        {
