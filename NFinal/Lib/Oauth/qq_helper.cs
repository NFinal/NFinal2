...
namespace NFinal.Lib.Oauth
{
    public class qq_helper
    {
        ...
        /// <returns>Dictionary</returns>
        public static IDictionary<string, object> get_open_id(string access_token)
        {
            ...
            //反序列化JSON
            IDictionary<string, object> dic = JsonHelper.DataRowFromJSON(result);
            return dic;
        }
        ...
        /// <returns>Dictionary</returns>
        public static IDictionary<string, object> get_user_info(string access_token, string open_id)
        {
            //获得配置信息
            oauth_config config = oauth_helper.get_config("qq");
        ...
        /// <param name="open_id">用户openid</param>
        /// <returns>Dictionary</returns>
        public static IDictionary<string,object> get_info(string access_token, string open_id)
        {
            //获得配置信息
            oauth_config config = oauth_helper.get_config("qq");
