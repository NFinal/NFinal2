...
namespace System
{
    public static class EnvironmentExtension
    {
        ...
        public static NFinal.MethodType GetMethodType(this IDictionary<string, object> environment)
        {
            string methodTypeTemp = (string)environment[OwinKeys.RequestMethod];
            NFinal.MethodType methodType;
            switch (methodTypeTemp)
            {
                case NFinal.Constant.MethodTypePOST: methodType = NFinal.MethodType.POST; break;
                case NFinal.Constant.MethodTypeGET: methodType = NFinal.MethodType.GET; break;
                case NFinal.Constant.MethodTypeDELETE: methodType = NFinal.MethodType.DELETE; break;
                case NFinal.Constant.MethodTypePUT: methodType = NFinal.MethodType.PUT; break;
                case NFinal.Constant.MethodTypeAJAX: methodType = NFinal.MethodType.AJAX; break;
        ...
        public static NFinal.Owin.Request GetRequest(this IDictionary<string, object> environment)
        {
            ...
            switch (methodTypeTemp)
            {
                case NFinal.Constant.MethodTypePOST: request.methodType = NFinal.MethodType.POST; break;
                case NFinal.Constant.MethodTypeGET: request.methodType = NFinal.MethodType.GET; break;
                case NFinal.Constant.MethodTypeDELETE: request.methodType = NFinal.MethodType.DELETE; break;
                case NFinal.Constant.MethodTypePUT: request.methodType = NFinal.MethodType.PUT; break;
                case NFinal.Constant.MethodTypeAJAX: request.methodType = NFinal.MethodType.AJAX; break;
            ...
            if (request.methodType == NFinal.MethodType.POST)
            {
                ...
                if (request.headers.ContainsKey(NFinal.Constant.HeaderContentType))
                {
                    ...
                    {
                        case NFinal.Constant.ContentType_Multipart_form_data: contentType = NFinal.ContentType.Multipart_form_data; break;
                        case NFinal.Constant.ContentType_Text_json:
                        case NFinal.Constant.ContentType_Application_json: contentType = NFinal.ContentType.Application_json; break;
                        case NFinal.Constant.ContentType_Application_x_www_form_urlencoded: contentType = NFinal.ContentType.Application_x_www_form_urlencoded; break;
                        case NFinal.Constant.ContentType_Application_xml:
                        case NFinal.Constant.ContentType_Text_xml: contentType = NFinal.ContentType.Text_xml; break;
                ...
                if (request.stream != System.IO.Stream.Null)
                {
                    ...
                    else if (contentType == NFinal.ContentType.Multipart_form_data)
                    {
                        ...
                        request.files = new Dictionary<string, NFinal.Owin.HttpMultipart.HttpFile>(StringComparer.Ordinal);
        ...
        {
            NFinal.Owin.HtmlWriter htmlWriter = new NFinal.Owin.HtmlWriter(environment.GetResponseBody(),NFinal.CompressMode.GZip);
            return htmlWriter;
        }
