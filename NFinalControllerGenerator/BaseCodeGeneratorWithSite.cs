...
namespace NFinalControllerGenerator
{
    ...
    public abstract class BaseCodeGeneratorWithSite : BaseCodeGenerator, VSOLE.IObjectWithSite
    {
        ...
        protected object GetServiceOjbect(Guid serviceGuid)
        {
        ...
        /// <returns>An object that implements the requested service</returns>
        protected object GetServiceObject(Type serviceType)
        {
        ...
        protected virtual CodeDomProvider GetCodeProvider()
        {
            if (codeDomProvider == null)
            {
                ...
                IVSMDCodeDomProvider provider = GetServiceObject(typeof(SVSMDCodeDomProvider)) as IVSMDCodeDomProvider;
                if (provider != null)
                {
        ...
        {
            object p = GetServiceObject(typeof(ProjectItem));
